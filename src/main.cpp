...
uint256 hashGenesisBlock("0x271a454de513dd902c3fdcc7924d586fd34ec06cd83a8dfd4070b3a38b16b081");
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // ByteCoin: 1 days
static const int64 nTargetSpacing = 30; // ByteCoin: half minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal ByteCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ByteCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0cc6dd9945dc3227bbc7a34346a6e11b8645defb4ff2bbf7ebc01100f3db40c6");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "27/8/13";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1377582192; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 901512;

        if (fTestNet)
        {
            block.nTime    = 1377570761;
            block.nNonce   = 0;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xa6b027a152ee0ad1f560d86b3454c9897f23e1a8612abaac5cad20d53999b30a"));
