...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        {
            // First part of help message is specific to ByteCoin server / RPC client
            std::string strUsage = _("ByteCoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  ByteCoin [options]                     " + "\n" +
                  "  ByteCoin [options] <command> [params]  " + _("Send command to -server or ByteCoin") + "\n" +
                  "  ByteCoin [options] help                " + _("List commands") + "\n" +
                  "  ByteCoin [options] help <command>      " + _("Get help for a command") + "\n";
...
{
    uiInterface.ThreadSafeMessageBox(str, _("ByteCoin"), CClientUIInterface::OK | CClientUIInterface::MODAL);
    return false;
}

bool static InitWarning(const std::string &str)
{
    uiInterface.ThreadSafeMessageBox(str, _("ByteCoin"), CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
    return true;
}
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: ByteCoin.pid)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 1722 or testnet: 4070)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 1721)") + "\n" +
...
//    }
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s.  ByteCoin is probably already running."), GetDataDir().string().c_str()));
